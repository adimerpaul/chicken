...
// nuevos reportes
    ...
    Route::get('reportes/insumos-sistema', [ReporteController::class, 'insumosSistema']);
...
// ✅ NUEVO: último cierre del usuario logueado
    ...
    Route::get('salesResumenProductosMesa', [SaleController::class, 'resumenProductosMesa']);
    Route::get('salesResumenProductosLlevar', [SaleController::class, 'resumenProductosLlevar']);
...
//    ingresos
    Route::post('ingresos', [App\Http\Controllers\VentaController::class, 'storeIngreso']);
